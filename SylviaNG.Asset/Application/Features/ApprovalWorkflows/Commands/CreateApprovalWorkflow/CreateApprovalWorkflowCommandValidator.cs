...
public class CreateApprovalWorkflowCommandValidator : AbstractValidator<CreateApprovalWorkflowCommand>
{
    public CreateApprovalWorkflowCommandValidator()
    {
        ...
        // A workflow with zero stages could never route anything - reject it outright rather than
        // let it silently create requisitions that get stuck (or auto-approve for the wrong reason).
